...
export class EntitiesHexa {
    ...
    generateTs() {
        ...
        this.configs.classes.forEach(e => {
            ...
            e.properties.forEach(p => {
                ...
                if (isTypePrimitive) {
                    ...
                    if (p.type.includes('[]')) {
                        ...
                        // add import relation models
                        importModels += `import ${this.configs.nameSpace}.components.${this.helper.lowerFirst(cls)}.models.*;\r\n`;
                        ...
                        const cls = this.helper.Cap(p.type !== 'any' ? p.type : p.name);
            ...
            models = models.replace('importModels', importModels);
